package com.example.aatmseva.swipe;
...
import com.example.aatmseva.R;
import com.example.aatmseva.SignupActivity;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        models.add(new Model(R.drawable.corona, "Covid19 Pandemic", "This Feature will help us to prevent the spread of Covid19 disease by dumping the infectious equipment " +
